...
censo.escolar  %>% 
  na.omit() %>% 
  group_by(Ano) %>% 
  mutate(Número_Matrículas_Ensino_Médio = Número_Matrículas_Ensino_Médio+Número_Matrículas_Ensino_Médio_EJA+Número_Matrículas_Ensino_Médio_Integral,
         Número_Matrículas_Ensino_Fundamental = Número_Matrículas_Ensino_Fundamental+Número_Matrículas_Ensino_Fundamental_integral,
         Número_Matrículas_Ensino_Fundamental_Anos_Iniciais = Número_Matrículas_Ensino_Fundamental_Anos_Iniciais+Número_Matrículas_Ensino_Fundamental_Anos_Iniciais_integral,
         Número_Matrículas_Ensino_Fundamental_Anos_Finais = Número_Matrículas_Ensino_Fundamental_Anos_Finais+Número_Matrículas_Ensino_Fundamental_Anos_Finais_integral) %>%
  summarize('Número de matrículas no Ensino Fundamental' = sum(Número_Matrículas_Ensino_Fundamental), 
            'Número de matrículas no Ensino Fundamental_Anos Iniciais' = sum(Número_Matrículas_Ensino_Fundamental_Anos_Iniciais), 
            'Número de matrículas no Ensino Fundamental_Anos Finais' = sum(Número_Matrículas_Ensino_Fundamental_Anos_Finais), 
            'Número de matrículas no Ensino Médio' = sum(Número_Matrículas_Ensino_Médio)) 
```
...
censo.escolar  %>% 
  na.omit() %>% 
  group_by(Ano) %>% 
  summarize('Ensino_Fundamental' = sum(Número_Matrículas_Ensino_Fundamental), 
            'Ensino_Fundamental_Anos_Iniciais' = sum(Número_Matrículas_Ensino_Fundamental_Anos_Iniciais), 
            'Ensino_Fundamental_Anos_Finais' = sum(Número_Matrículas_Ensino_Fundamental_Anos_Finais), 
            'Ensino_Médio' = sum(Número_Matrículas_Ensino_Médio)) %>%
...
Actually, there is something wrong with this graph. The official government's webpage inform us that the number of enrollment at high school are 6.6 millions of students.

<https://www.gov.br/inep/pt-br/assuntos/noticias/censo-escolar/inep-divulga-dados-da-1a-etapa-do-censo-escolar-2021>
