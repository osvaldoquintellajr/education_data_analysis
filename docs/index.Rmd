...
saeb.2021.5EF <- read.data("~/Documentos/microdados/SAEB/microdados_saeb_2021_ensino_fundamental_e_medio/DADOS/TS_ALUNO_5EF.csv", 
...
```{r formatar variáveis categóricas, echo=FALSE, warning=FALSE, message=FALSE}
