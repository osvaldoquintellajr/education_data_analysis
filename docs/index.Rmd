...
censo.escolar <- censo.escolar %>% mutate(
  ...
  Computadores_em_uso_pelos_alunos_desktop = as_factor(if_else(Computadores_em_uso_pelos_alunos_desktop == 1, 'Sim',
                                                               if_else(Computadores_em_uso_pelos_alunos_desktop == 0, 'Não', NA))),
  Computadores_em_uso_pelos_alunos_portátil = as_factor(if_else(Computadores_em_uso_pelos_alunos_portátil == 1, 'Sim', 
                                                                if_else(Computadores_em_uso_pelos_alunos_portátil == 0, 'Não', NA))),
  Computadores_em_uso_pelos_alunos_tablet = as_factor(if_else(Computadores_em_uso_pelos_alunos_tablet == 1, 'Sim', 
                                                              if_else(Computadores_em_uso_pelos_alunos_tablet == 0, 'Não', NA))),
  ...
  Acesso_Internet_processos_de_ensino_aprendizagem = as_factor(if_else(Acesso_Internet_processos_de_ensino_aprendizagem == 1, 'Sim', 
                                                                       if_else(Acesso_Internet_processos_de_ensino_aprendizagem == 0, 'Não', NA))),
  Acesso_Internet_Para_comunidade = as_factor(if_else(Acesso_Internet_Para_comunidade == 1, 'Sim', 
                                                      if_else(Acesso_Internet_Para_comunidade == 0, 'Não', NA))),
...
#### Desktops vailables to students.


```{r tablets, echo=FALSE, message=FALSE, warning=FALSE}
censo.escolar %>%
  group_by(Ano,Dependência_Administrativa) %>% 
  summarise('Quantidade_desktops_disponíveis' = sum(Quantidade_computadores_em_uso_pelos_alunos_desktop, na.rm = TRUE))
```

The table above has information about the number of desktops available to students. Let's explore this information.
