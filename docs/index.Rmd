...
saeb.2021.5EF.regressão <- saeb.2021.5EF %>%
  ...
  filter(Sexo %in% c("Masculino", "Feminino") & 
           Raça %in% c("Branca", "Preta", "Parda", "Amarela", "Indígena") & 
           Escolaridade_Mãe %in% c("Não completou o 5° ano do Ensino Fundamental", "Ensino Fundamental, até o 5° ano", "Ensino Fundamental completo", "Ensino Médio completo", "Ensino Superior completo (faculdade ou graduação)") &
           Escolaridade_Pai %in% c("Não completou o 5° ano do Ensino Fundamental", "Ensino Fundamental, até o 5° ano", "Ensino Fundamental completo", "Ensino Médio completo", "Ensino Superior completo (faculdade ou graduação)")) %>%
  mutate(Sexo = if_else(Sexo == "Masculino", 1, 0),
         ...
         Escolaridade_Pai = if_else(Escolaridade_Pai == '))
  
  

lm(PROFICIENCIA_LP_SAEB ~ Sexo + Localização + )
```